...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-8 pb-12 max-w-full">
      ...
      {/* Stats Cards */}
      <SectionErrorBoundary section="Dashboard Stats" fallbackTitle="Stats unavailable">
        <DashboardStats
          ...
          <Dialog open={quickEventOpen} onOpenChange={setQuickEventOpen}>
            <DialogTrigger asChild>
              <Button className="w-full h-14 bg-teal-500 hover:bg-teal-600 text-white text-base font-semibold min-w-0">
                ...
                <span className="truncate">{t('add_new_care_event')}</span>
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-2xl font-playfair">
                  {t('quick_care_event_multi')}
                </DialogTitle>
              </DialogHeader>
              <form onSubmit={handleQuickEvent} className="space-y-4">
                  ...
                  {selectedMemberIds.length > 0 && (
                    <div className="p-3 bg-teal-50 rounded border">
                      <p className="font-semibold text-sm mb-2">
                        {t('labels.selected_members_count', { count: selectedMemberIds.length })}:
                      </p>
                      <div className="flex flex-wrap gap-2">
                        {selectedMemberIds.map((id) => {
                          ...
                          return member ? (
                            <span
                              key={id}
                              className="bg-teal-100 text-teal-800 px-2 py-1 rounded text-xs flex items-center gap-1"
                            >
                              {member.name}
                              <button
                                type="button"
                ...
                <div>
                  ...
                  <Select
                    value={quickEvent.event_type}
                    onValueChange={(v) => setQuickEvent({ ...quickEvent, event_type: v })}
                  >
                    <SelectTrigger className="h-12">
                      <SelectValue placeholder={t('form_placeholders.select_event_type')} />
                    </SelectTrigger>
                    <SelectContent>
                    ...
                    <Popover modal={true} open={eventDateOpen} onOpenChange={setEventDateOpen}>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {quickEvent.event_date ? (
                            formatDateFns(new Date(quickEvent.event_date), 'dd MMM yyyy')
                          ) : (
                      ...
                      <PopoverContent className="p-0 z-[9999]" side="bottom" align="start">
                        <div className="w-[280px]">
                          <CalendarComponent
                            mode="single"
                            selected={
                              quickEvent.event_date ? new Date(quickEvent.event_date) : undefined
                            }
                            onSelect={(date) => {
                              if (date) {
                                setQuickEvent({
                                  ...quickEvent,
                                  event_date: formatDateFns(date, 'yyyy-MM-dd'),
                                });
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder={t('form_placeholders.additional_details')}
                    className="h-12"
                  />
                </div>
                ...
                {quickEvent.event_type === 'financial_aid' && (
                  <div>
                    ...
                    <Input
                      ...
                      placeholder={t('form_placeholders.monthly_education_support')}
                      className="h-12"
                      required
                    />
                  </div>
                ...
                {quickEvent.event_type === 'grief_loss' && (
                  <div className="space-y-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <p className="text-sm font-medium text-purple-900">
                      ⭐ Auto-generates 6-stage grief timeline
                    </p>
                    <div>
                      <Label className="font-semibold">Relationship to Deceased</Label>
                      <Select
                        value={quickEvent.grief_relationship}
                        onValueChange={(v) =>
                          setQuickEvent({ ...quickEvent, grief_relationship: v })
                        }
                        required
                      >
                        <SelectTrigger className="h-12">
                          <SelectValue placeholder={t('form_placeholders.select_relationship')} />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setQuickEvent({ ...quickEvent, hospital_name: e.target.value })
                        }
                  ...
                  <div className="space-y-4 p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select
                          value={quickEvent.aid_type}
                          onValueChange={(v) => setQuickEvent({ ...quickEvent, aid_type: v })}
                          required
                        >
                          <SelectTrigger className="h-12">
                            <SelectValue placeholder={t('form_placeholders.select_aid_type')} />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setQuickEvent({ ...quickEvent, aid_amount: e.target.value })
                          }
                    ...
                    <div className="space-y-4 border-t pt-4">
                      ...
                      <div>
                        ...
                        <Select
                          value={quickEvent.schedule_frequency || 'one_time'}
                          onValueChange={(v) =>
                            setQuickEvent({ ...quickEvent, schedule_frequency: v })
                          }
                        >
                          <SelectTrigger className="h-12">
                            <SelectValue placeholder={t('form_placeholders.select_frequency')} />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="one_time">
                              One-time Payment (already given)
                            </SelectItem>
                            <SelectItem value="weekly">
                              Weekly Schedule (future payments)
                            </SelectItem>
                            <SelectItem value="monthly">
                              Monthly Schedule (future payments)
                            </SelectItem>
                            <SelectItem value="annually">
                              Annual Schedule (future payments)
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                        ...
                        <div>
                          ...
                          >
                            <PopoverTrigger asChild>
                              ...
                              >
                                <CalendarIcon className="mr-2 h-4 w-4" />
                                {quickEvent.payment_date ? (
                                  formatDateFns(new Date(quickEvent.payment_date), 'dd MMM yyyy')
                                ) : (
                            ...
                            <PopoverContent className="p-0 z-[9999]" side="bottom" align="start">
                              <div className="w-[280px]">
                                <CalendarComponent
                                  ...
                                  selected={
                                    quickEvent.payment_date
                                      ? new Date(quickEvent.payment_date)
                                      : undefined
                                  }
                                  onSelect={(date) => {
                                    if (date) {
                                      setQuickEvent({
                                        ...quickEvent,
                                        payment_date: formatDateFns(date, 'yyyy-MM-dd'),
                                      });
                      ...
                      {quickEvent.schedule_frequency === 'weekly' && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 bg-blue-50 rounded">
                          <div>
                            ...
                            <Select
                              value={quickEvent.day_of_week || 'monday'}
                              onValueChange={(v) =>
                                setQuickEvent({ ...quickEvent, day_of_week: v })
                              }
                            >
                              <SelectTrigger className="h-12">
                                <SelectValue />
                          ...
                          <div>
                            ...
                            <Popover modal={true} open={endDateOpen} onOpenChange={setEndDateOpen}>
                              <PopoverTrigger asChild>
                                ...
                                >
                                  <CalendarIcon className="mr-2 h-4 w-4" />
                                  {quickEvent.schedule_end_date ? (
                                    formatDateFns(
                                      new Date(quickEvent.schedule_end_date),
                                      'dd MMM yyyy'
                                    )
                                  ) : (
                                    <span className="text-muted-foreground">
                                      {t('form_placeholders.no_end_date')}
                                    </span>
                                  )}
                                </Button>
                              </PopoverTrigger>
                                  ...
                                  <CalendarComponent
                                    ...
                                    onSelect={(date) => {
                                      if (date) {
                                        setQuickEvent({
                                          ...quickEvent,
                                          schedule_end_date: formatDateFns(date, 'yyyy-MM-dd'),
                                        });
                        ...
                        <div className="space-y-3 p-3 bg-purple-50 rounded">
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                              ...
                              <Select
                                value={(
                                  quickEvent.start_month || new Date().getMonth() + 1
                                ).toString()}
                                onValueChange={(v) =>
                                  setQuickEvent({ ...quickEvent, start_month: parseInt(v) })
                                }
                              >
                                <SelectTrigger className="h-12">
                                  <SelectValue />
                            ...
                            <div>
                              ...
                              <Select
                                value={(
                                  quickEvent.start_year || new Date().getFullYear()
                                ).toString()}
                                onValueChange={(v) =>
                                  setQuickEvent({ ...quickEvent, start_year: parseInt(v) })
                                }
                              >
                                <SelectTrigger className="h-12">
                                  <SelectValue />
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              placeholder={t('form_placeholders.day_example')}
                              className="h-12"
                              required
                            />
                          </div>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                              ...
                              <Select
                                value={(quickEvent.end_month || 'none').toString()}
                                onValueChange={(v) =>
                                  setQuickEvent({
                                    ...quickEvent,
                                    end_month: v === 'none' ? null : parseInt(v),
                                  })
                                }
                              >
                                <SelectTrigger className="h-12">
                                  <SelectValue placeholder={t('form_placeholders.no_end_date')} />
                                </SelectTrigger>
                                <SelectContent>
                            ...
                            <div>
                              ...
                              <Select
                                value={(quickEvent.end_year || 'none').toString()}
                                onValueChange={(v) =>
                                  setQuickEvent({
                                    ...quickEvent,
                                    end_year: v === 'none' ? null : parseInt(v),
                                  })
                                }
                              >
                                <SelectTrigger className="h-12">
                      ...
                      {quickEvent.schedule_frequency === 'annually' && (
                        <div className="grid grid-cols-2 gap-3 p-3 bg-orange-50 rounded">
                          <div>
                            ...
                            <Select
                              value={(quickEvent.month_of_year || 1).toString()}
                              onValueChange={(v) =>
                                setQuickEvent({ ...quickEvent, month_of_year: parseInt(v) })
                              }
                            >
                              <SelectTrigger>
                                <SelectValue />
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              value={
                                quickEvent.schedule_end_date
                                  ? new Date(quickEvent.schedule_end_date).getFullYear()
                                  : ''
                              }
                              onChange={(e) =>
                                setQuickEvent({
                    ...
                    <p className="text-sm text-green-700">
                      Total: Rp{' '}
                      {((quickEvent.aid_amount || 0) * selectedMemberIds.length).toLocaleString(
                        'id-ID'
                      )}{' '}
                      for {selectedMemberIds.length} members
                    </p>
                  </div>
                )}
                ...
                <div className="flex gap-3 pt-4">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setQuickEventOpen(false)}
      ...
      <SectionErrorBoundary section="Task Tabs" fallbackTitle="Tasks could not be loaded">
        <Tabs defaultValue="today" className="w-full">
            ...
            <TabsList className="flex w-full">
              ...
              <TabsTrigger value="overdue" className="flex-1">
                ...
                <span className="ml-1 text-xs">
                  (
                  {overdueBirthdays.length +
                    griefDue.length +
                    accidentFollowUp.length +
                    financialAidDue.length +
                  ...
                  <Card className="card-border-left-teal">
                    <CardHeader>
                      <CardTitle className="text-xl">
                        {t('other_tasks_due_today')} ({todayTasks.length})
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                        ...
                        {todayTasks.map((task, index) => {
                          const typeConfig = {
                            ...
                            accident_followup: {
                              ...
                              label: t('accident_followup_label'),
                            },
                            financial_aid: {
                              icon: '💰',
                              color: 'green',
                          ...
                          const isSelectableTask =
                            task.type === 'grief_support' || task.type === 'accident_followup';
                          const isTaskSelected =
                            taskId && isSelectableTask && bulkSelection.isSelected(taskId);

                          return (
                            <div
                              key={index}
                              className={`p-4 ${config.bgClass} rounded-lg border ${isTaskSelected ? 'border-teal-500 ring-2 ring-teal-200' : config.borderClass} relative hover:shadow-lg transition-all`}
                            >
                              {/* Overdue Badge - Top Right */}
                              {task.days_overdue > 0 && (
                                <span
                                  className={`absolute top-3 ${selectionMode && isSelectableTask ? 'right-10' : 'right-3'} px-2 py-1 bg-red-500 text-white text-xs font-semibold rounded shadow-sm z-10`}
                                >
                              ...
                              <div className="flex items-start gap-3 mb-3">
                                ...
                                <div
                                  className={`flex-shrink-0 rounded-full ring-2 ${
                                    config.color === 'pink'
                                      ? 'ring-pink-400'
                                      : config.color === 'blue'
                                        ? 'ring-blue-400'
                                ...
                                >
                                  <MemberAvatar
                                    member={{
                                      ...
                                      photo_url: task.member_photo_url,
                                    }}
                                    size="md"
                                    enableTransition
                                  />
                                ...
                                <div className="flex-1 min-w-0">
                                  <MemberLink
                                    ...
                                    style={{ viewTransitionName: `member-name-${task.member_id}` }}
                                  >
                                    {task.member_name}
                                  </MemberLink>
                                  {task.member_phone && (
                                    <a
                                      href={`tel:${task.member_phone}`}
                                  ...
                                  <p className="text-sm text-muted-foreground mt-1">
                                    ...
                                    {task.days_since_last_contact > 0 && (
                                      <span className="ml-2 text-xs">
                                        • Last contact {task.days_since_last_contact}d ago
                                      </span>
                                    )}
                                  </p>
                                </div>
                              ...
                              <div className="flex gap-2">
                                ...
                                >
                                  <a
                                    href={formatPhoneForWhatsApp(task.member_phone)}
                                    target="_blank"
                                  ...
                                  <>
                                    <Button
                                      ...
                                      onClick={async () => {
                                        try {
                                          await api.post(
                                            `/financial-aid-schedules/${task.data.id}/mark-distributed`
                                          );
                                      ...
                                      <DropdownMenuContent align="end" className="w-40">
                                        <DropdownMenuItem
                                          onClick={async () => {
                                            try {
                                              await api.post(
                                                `/financial-aid-schedules/${task.data.id}/ignore`
                                              );
                                        ...
                                        <DropdownMenuItem
                                          ...
                                          onClick={async () => {
                                            try {
                                              await api.post(
                                                `/financial-aid-schedules/${task.data.id}/stop`
                                              );
                                      ...
                                      onClick={async () => {
                                        ...
                                        try {
                                          if (task.type === 'grief_support') {
                                            ...
                                            await api.post(
                                              `/accident-followup/${task.data.id}/complete`
                                            );
                                        ...
                                        <DropdownMenuItem
                                          onClick={async () => {
                                            try {
                                              if (task.type === 'grief_support') {
                                                await api.post(
                                                  `/grief-support/${task.data.id}/ignore`
                                                );
                                                toast.success(t('toasts.grief_ignored'));
                                              } else if (task.type === 'accident_followup') {
                                                await api.post(
                                                  `/accident-followup/${task.data.id}/ignore`
                                                );
          ...
          <TabsContent value="overdue" className="space-y-4">
            <Tabs
              ...
              className="w-full"
              onValueChange={(v) => setActiveOverdueTab(v)}
            >
                ...
                <TabsList className="inline-flex min-w-full w-max sm:w-full">
                  <TabsTrigger value="birthdays" className="flex-shrink-0">
                    ...
                    {activeOverdueTab === 'birthdays' ? (
                      <span className="ml-2">
                        {t('nested_tabs.birthday')} ({overdueBirthdays.length})
                      </span>
                    ) : (
                  ...
                  <TabsTrigger value="followups" className="flex-shrink-0">
                    ...
                    {activeOverdueTab === 'followups' ? (
                      <span className="ml-2">
                        {t('nested_tabs.followups')} ({griefDue.length + accidentFollowUp.length})
                      </span>
                    ) : (
                  ...
                  <TabsTrigger value="financial" className="flex-shrink-0">
                    ...
                    {activeOverdueTab === 'financial' ? (
                      <span className="ml-2">
                        {t('nested_tabs.aid')} ({financialAidDue.length})
                      </span>
                    ) : (
                  ...
                  <TabsTrigger value="atrisk" className="flex-shrink-0">
                    ...
                    {activeOverdueTab === 'atrisk' ? (
                      <span className="ml-2">
                        {t('nested_tabs.at_risk')} ({atRiskMembers.length})
                      </span>
                    ) : (
                  ...
                  <TabsTrigger value="disconnected" className="flex-shrink-0">
                    ...
                    {activeOverdueTab === 'disconnected' ? (
                      <span className="ml-2">
                        {t('nested_tabs.inactive')} ({disconnectedMembers.length})
                      </span>
                    ) : (
              ...
              <TabsContent value="birthdays" className="space-y-4 mt-4">
                {overdueBirthdays.length === 0 ? (
                  ...
                  <Card className="border-amber-200">
                    <CardHeader>
                      <CardTitle>
                        {t('overdue_birthdays')} ({overdueBirthdays.length})
                      </CardTitle>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {sortedOverdueBirthdays.map((event) => (
                          <div
                            key={event.id}
                            className={`p-4 bg-amber-50 rounded-lg border ${bulkSelection.isSelected(event.id) ? 'border-teal-500 ring-2 ring-teal-200' : 'border-amber-200'} relative hover:shadow-lg transition-all`}
                          >
                            {event.days_overdue > 0 && (
                              <span
                                className={`absolute top-3 ${selectionMode ? 'right-10' : 'right-3'} px-2 py-1 bg-red-500 text-white text-xs font-semibold rounded shadow-sm z-10`}
                              >
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {hospitalFollowUp.map((event) => (
                          <div
                            key={event.id}
                            className="p-4 bg-blue-50 rounded-lg border border-blue-200 relative hover:shadow-lg transition-all"
                          >
                            {/* Overdue Badge */}
                            {event.days_overdue > 0 && (
                            ...
                            <div className="flex items-start gap-3 mb-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                  ...
                                  {event.days_since_last_contact && (
                                    <span className="ml-2 text-xs">
                                      • Last contact {event.days_since_last_contact}d ago
                                    </span>
                                  )}
                                </p>
                              </div>
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="default"
                                className="bg-blue-500 hover:bg-blue-600 text-white h-11 flex-1 min-w-0"
                                asChild
                              >
                                <a
                                  href={formatPhoneForWhatsApp(event.member_phone)}
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {accidentFollowUp.map((followup) => (
                          <div
                            key={followup.id}
                            className="p-4 bg-teal-50 rounded-lg border border-teal-200 relative hover:shadow-lg transition-all"
                          >
                            ...
                            <div className="flex items-start gap-3 mb-3">
                              ...
                              <div className="flex-shrink-0 rounded-full ring-2 ring-teal-400">
                                <MemberAvatar
                                  member={{
                                    id: followup.member_id,
                                    name: followup.member_name,
                                    photo_url: followup.member_photo_url,
                                  }}
                                  size="md"
                                  enableTransition
                                />
                              ...
                              <div className="flex-1 min-w-0">
                                <MemberLink
                                  ...
                                  className="font-semibold text-base hover:text-teal-600"
                                  style={{
                                    viewTransitionName: `member-name-${followup.member_id}`,
                                  }}
                                >
                                ...
                                {followup.member_phone && (
                                  <a
                                    href={`tel:${followup.member_phone}`}
                                    className="text-sm text-teal-600 hover:text-teal-700 flex items-center gap-1 mt-1"
                                  >
                                    📞 {followup.member_phone}
                                  </a>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                  ...
                                  {followup.days_since_last_contact && (
                                    <span className="ml-2 text-xs">
                                      • Last contact {followup.days_since_last_contact}d ago
                                    </span>
                                  )}
                                </p>
                              </div>
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="default"
                                className="bg-teal-500 hover:bg-teal-600 text-white h-11 flex-1 min-w-0"
                                asChild
                              >
                                <a
                                  href={formatPhoneForWhatsApp(followup.member_phone)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1"
                                >
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {griefDue.map((stage) => (
                          <div
                            key={stage.id}
                            className="p-4 bg-purple-50 rounded-lg border border-purple-200 relative hover:shadow-lg transition-all"
                          >
                            {/* Overdue Badge */}
                            ...
                            <div className="flex items-start gap-3 mb-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <MemberLink
                                  ...
                                  className="font-semibold text-base hover:text-teal-600"
                                  style={{ viewTransitionName: `member-name-${stage.member_id}` }}
                                >
                                  {stage.member_name}
                                </MemberLink>
                                {stage.member_phone && (
                                  <a
                                    href={`tel:${stage.member_phone}`}
                                    className="text-sm text-teal-600 hover:text-teal-700 flex items-center gap-1 mt-1"
                                  >
                                    📞 {stage.member_phone}
                                  </a>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                  ...
                                  after mourning
                                  {stage.days_since_last_contact && (
                                    <span className="ml-2 text-xs">
                                      • Last contact {stage.days_since_last_contact}d ago
                                    </span>
                                  )}
                                </p>
                              </div>
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="default"
                                className="bg-purple-500 hover:bg-purple-600 text-white h-11 flex-1 min-w-0"
                                asChild
                              >
                                <a
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  triggerHaptic();
                                  markGriefStageComplete(stage.id, queryClient, t);
                                }}
                                className="h-11 flex-1 min-w-0 bg-white hover:bg-gray-50"
                              >
                                <Check className="w-4 h-4 mr-1" />
                            ...
                            <div className="flex items-start gap-3 mb-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {schedule.member_phone && (
                                  <a
                                    href={`tel:${schedule.member_phone}`}
                                    className="text-sm text-teal-600 hover:text-teal-700 flex items-center gap-1 mt-1"
                                  >
                                    📞 {schedule.member_phone}
                                  </a>
                                ...
                                <p className="text-xs text-muted-foreground mt-1 flex items-center gap-2 flex-wrap">
                                  ...
                                  <span>
                                    {schedule.aid_type
                                      ? schedule.aid_type.charAt(0).toUpperCase() +
                                        schedule.aid_type.slice(1)
                                      : 'Unknown'}
                                  </span>
                                </p>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  showConfirm(
                                    ...
                                    t('confirmations.mark_distributed', {
                                      name: schedule.member_name,
                                    }),
                                    async () => {
                                      try {
                                ...
                                <DropdownMenuContent align="end" className="w-40">
                                  <DropdownMenuItem
                                    onClick={async () => {
                                      try {
                                        await api.post(
                                          `/financial-aid-schedules/${schedule.id}/ignore`
                                        );
                                  ...
                                  <DropdownMenuItem
                                    ...
                                    onClick={() => {
                                      showConfirm(
                                        'Stop Aid Schedule',
                                        t('confirmations.stop_schedule', {
                                          name: schedule.member_name,
                                        }),
                                        async () => {
                                          try {
                                            await api.post(
                                              `/financial-aid-schedules/${schedule.id}/stop`
                                            );
                                            toast.success(t('toasts.schedule_stopped'));
                                            await queryClient.invalidateQueries({
                                              queryKey: ['dashboard'],
              ...
              <TabsContent value="atrisk" className="space-y-4 mt-4">
                {atRiskMembers.length === 0 ? (
                  ...
                  <Card className="border-amber-200">
                    <CardHeader>
                      <CardTitle>
                        {t('members_at_risk_days', {
                          min: engagementSettings.atRiskDays,
                          max: engagementSettings.inactiveDays - 1,
                        })}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        {atRiskMembers.map((member) => (
                          <div
                            key={member.id}
                            className="p-4 bg-amber-50 rounded-lg border border-amber-200 hover:shadow-lg transition-all"
                          >
                            <div className="flex items-start gap-3 mb-3">
                              <div className="flex-shrink-0 rounded-full ring-2 ring-amber-400">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                  ...
                                  {member.age && (
                                    <span className="ml-2 text-xs">• {member.age} years old</span>
                                  )}
                                </p>
                              </div>
                            </div>
              ...
              <TabsContent value="disconnected" className="space-y-4 mt-4">
                {disconnectedMembers.length === 0 ? (
                  ...
                  <Card className="border-red-200">
                    <CardHeader>
                      <CardTitle>
                        {t('members_disconnected_days', { days: engagementSettings.inactiveDays })}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        {disconnectedMembers.slice(0, 15).map((member) => (
                          <div
                            key={member.id}
                            className="p-4 bg-red-50 rounded-lg border border-red-200 hover:shadow-lg transition-all"
                          >
                            <div className="flex items-start gap-3 mb-3">
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="default"
                                className="bg-red-500 hover:bg-red-600 text-white h-11 flex-1 min-w-0"
                                asChild
                              >
                                <a
                                  href={formatPhoneForWhatsApp(member.phone)}
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-start gap-3 mb-3">
                            ...
                            <div
                              className={`flex-shrink-0 rounded-full ring-2 ${config.ringColor}`}
                            >
                              <MemberAvatar
                                member={{
                                  id: task.member_id,
                                ...
                                {task.type === 'birthday' ? (
                                  <>
                                    ...
                                    {task.member_age && typeof task.member_age === 'number' && (
                                      <span className="ml-2 text-xs">
                                        • Will be {task.member_age + 1} years old
                                      </span>
                                    )}
                                  </>
                                  ...
                                  <>
                                    <span className="font-medium">{config.label}:</span>{' '}
                                    {getAccidentStageBadge(task.data.stage)}
                                  </>
                                ) : task.type === 'grief_support' ? (
                                  <>
                                    <span className="px-2 py-0.5 bg-purple-500 text-white text-xs rounded mr-2">
      ...
      <div className="mt-6">
        <SectionErrorBoundary section="Activity Feed" fallbackTitle="Activity feed unavailable">
