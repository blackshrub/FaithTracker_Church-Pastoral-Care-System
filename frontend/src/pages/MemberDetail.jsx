...
export const MemberDetail = () => {
  ...
  const { data: memberData, isLoading } = useQuery({
    queryKey: ['member', id],
    queryFn: async () => {
      const [memberRes, eventsRes, griefRes, accidentRes, aidSchedulesRes, notesRes] =
        await Promise.all([
          api.get(`/members/${id}`),
    ...
    try {
      if (newEvent.event_type === 'financial_aid') {
        ...
        const autoTitle =
          ...
          eventTypeTitles[newEvent.event_type] ||
          'Care Event';
  ...
  return (
    <div className="space-y-6 max-w-full">
      {/* Header */}
      <MemberProfileHeader member={member} onAddCareEvent={() => setEventModalOpen(true)} />

      {/* Add Care Event Dialog */}
      <Dialog open={eventModalOpen} onOpenChange={setEventModalOpen}>
        <DialogContent
          className="max-w-2xl max-h-[90vh] overflow-y-auto"
          data-testid="add-care-event-modal"
        >
          <DialogHeader>
          ...
          <form onSubmit={handleAddCareEvent} className="space-y-4">
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="accident_illness">
                    🚑 {t('event_types.accident_illness')}
                  </SelectItem>
                  <SelectItem value="financial_aid">💰 {t('event_types.financial_aid')}</SelectItem>
                  <SelectItem value="regular_contact">
                    📞 {t('event_types.regular_contact')}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
                ...
                <Popover modal={true} open={eventDateOpen} onOpenChange={setEventDateOpen}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {newEvent.event_date ? (
                        formatDateFns(new Date(newEvent.event_date), 'dd MMM yyyy')
                      ) : (
            ...
            {newEvent.event_type === 'grief_loss' && (
              <div className="space-y-4 p-4 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200">
                ...
                <div>
                  ...
                  <Select
                    value={newEvent.grief_relationship}
                    onValueChange={(v) => setNewEvent({ ...newEvent, grief_relationship: v })}
                    required
                  >
              ...
              <div className="space-y-4 p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      value={newEvent.aid_type}
                      onValueChange={(v) => setNewEvent({ ...newEvent, aid_type: v })}
                      required
                    >
                      <SelectTrigger className="h-12">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="funeral_costs">
                          {t('aid_types.funeral_costs')}
                        </SelectItem>
                ...
                <div className="space-y-4 border-t pt-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={newEvent.schedule_frequency}
                      onValueChange={(v) => setNewEvent({ ...newEvent, schedule_frequency: v })}
                    >
                      <SelectTrigger className="h-12">
                    ...
                    <div>
                      ...
                      >
                        <PopoverTrigger asChild>
                          ...
                          >
                            <CalendarIcon className="mr-2 h-4 w-4" />
                            {newEvent.payment_date ? (
                              formatDateFns(new Date(newEvent.payment_date), 'dd MMM yyyy')
                            ) : (
                              <span className="text-muted-foreground">Select payment date...</span>
                            )}
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent className="p-0 z-[9999]" side="bottom" align="start">
                          <div className="w-[280px]">
                            <CalendarComponent
                              mode="single"
                              selected={
                                newEvent.payment_date ? new Date(newEvent.payment_date) : undefined
                              }
                              onSelect={(date) => {
                                if (date) {
                                  setNewEvent({
                    ...
                    <div className="grid grid-cols-2 gap-3 p-3 bg-blue-50 dark:bg-blue-950 rounded">
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(v) => setNewEvent({ ...newEvent, day_of_week: v })}
                        >
                          <SelectTrigger className="h-12">
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div>
                        ...
                        <Popover modal={true} open={endDateOpen} onOpenChange={setEndDateOpen}>
                          <PopoverTrigger asChild>
                            ...
                            >
                              <CalendarIcon className="mr-2 h-4 w-4" />
                              {newEvent.schedule_end_date ? (
                                formatDateFns(new Date(newEvent.schedule_end_date), 'dd MMM yyyy')
                              ) : (
                          ...
                          <PopoverContent className="p-0 z-[9999]" side="bottom" align="start">
                            <div className="w-[280px]">
                              <CalendarComponent
                                ...
                                selected={
                                  newEvent.schedule_end_date
                                    ? new Date(newEvent.schedule_end_date)
                                    : undefined
                                }
                                onSelect={(date) => {
                                  if (date) {
                    ...
                    <div className="space-y-3 p-3 bg-purple-50 dark:bg-purple-950 rounded">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select
                            value={(newEvent.start_month || new Date().getMonth() + 1).toString()}
                            onValueChange={(v) =>
                              setNewEvent({ ...newEvent, start_month: parseInt(v) })
                            }
                          >
                            <SelectTrigger className="h-12">
                              <SelectValue />
                        ...
                        <div>
                          ...
                          <Select
                            value={(newEvent.start_year || new Date().getFullYear()).toString()}
                            onValueChange={(v) =>
                              setNewEvent({ ...newEvent, start_year: parseInt(v) })
                            }
                          >
                            <SelectTrigger className="h-12">
                              <SelectValue />
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select
                            value={(newEvent.end_month || 'none').toString()}
                            onValueChange={(v) =>
                              setNewEvent({
                                ...newEvent,
                        ...
                        <div>
                          ...
                          <Select
                            value={(newEvent.end_year || 'none').toString()}
                            onValueChange={(v) =>
                              setNewEvent({
                                ...newEvent,
                  ...
                  {newEvent.schedule_frequency === 'annually' && (
                    <div className="grid grid-cols-2 gap-3 p-3 bg-orange-50 dark:bg-orange-950 rounded">
                      <div>
                        ...
                        <Select
                          value={newEvent.month_of_year.toString()}
                          onValueChange={(v) =>
                            setNewEvent({ ...newEvent, month_of_year: parseInt(v) })
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          value={
                            newEvent.schedule_end_date
                              ? new Date(newEvent.schedule_end_date).getFullYear()
                              : ''
                          }
                          onChange={(e) =>
                            setNewEvent({
                              ...newEvent,
                              schedule_end_date: e.target.value ? `${e.target.value}-12-31` : '',
                            })
                          }
                          placeholder="2030"
                        />
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                ...
                data-testid="save-care-event-button"
              >
                Save Care Event
              </Button>
            </div>
      ...
      <Card className="border-border max-w-full">
        <CardContent className="p-4 sm:p-6">
          ...
          {member.notes && <p className="text-sm text-muted-foreground mt-4">{member.notes}</p>}
        </CardContent>
      </Card>

      {/* Pastoral Notes Section - Visible in Header */}
      <SectionErrorBoundary section="Pastoral Notes" fallbackTitle="Pastoral notes unavailable">
        <Card className="mb-4">
              ...
              <div className="mt-4">
                {pastoralNotes.length === 0 ? (
                  <p className="text-sm text-muted-foreground text-center py-4">
                    No pastoral notes yet. Add notes about special needs, health conditions,
                    spiritual concerns, etc.
                  </p>
                ) : (
                          ...
                          <div className="flex justify-between items-start gap-3">
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 flex-wrap mb-1">
                                ...
                                {note.category && (
                                  <span
                                    className={`text-xs px-2 py-0.5 rounded border ${categoryColors[note.category] || 'bg-gray-100'}`}
                                  >
                              ...
                              <p className="text-xs text-muted-foreground mt-1 opacity-60">
                                ...
                                {formatDate(note.created_at, 'dd MMM yyyy')}
                              </p>
                            </div>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                {note.follow_up_date && !note.follow_up_completed && (
                                  <DropdownMenuItem
                                    onClick={() => handleCompleteNoteFollowup(note.id)}
                                  >
      ...
      <SectionErrorBoundary section="Care Tabs" fallbackTitle="Care history could not be loaded">
        <Tabs defaultValue="timeline" className="w-full">
            ...
            <TabsList className="inline-flex min-w-full w-max sm:w-full">
              ...
              {griefTimeline.length > 0 && (
                <TabsTrigger value="grief" data-testid="tab-grief" className="flex-shrink-0">
                  ...
                  <span className="hidden sm:inline">Grief</span> ({griefTimeline.length})
                </TabsTrigger>
              )}
              {careEvents.filter(
                (e) =>
                  e.event_type === 'accident_illness' && !e.accident_stage_id && !e.care_event_id
              ).length > 0 && (
                <TabsTrigger value="accident" data-testid="tab-accident" className="flex-shrink-0">
                  <Hospital className="w-4 h-4 sm:mr-2" />
                  <span className="hidden sm:inline">Accident/Illness</span> (
                  {
                    careEvents.filter(
                      (e) =>
                        e.event_type === 'accident_illness' &&
                        !e.accident_stage_id &&
                        !e.care_event_id
                    ).length
                  }
              ...
              {(careEvents.filter((e) => e.event_type === 'financial_aid').length > 0 ||
                ...
                <TabsTrigger value="aid" data-testid="tab-aid" className="flex-shrink-0">
                  ...
                  <span className="hidden sm:inline">Aid</span> (
                  {careEvents.filter(
                    (e) =>
                      e.event_type === 'financial_aid' &&
                      !(e.aid_notes && e.aid_notes.includes('schedule'))
                  ).length + aidSchedules.length}
                  )
                </TabsTrigger>
              )}
            </TabsList>
          ...
          <TabsContent value="timeline" className="space-y-4">
            ...
            {(() => {
              ...
              const showBanner =
                daysUntil >= -writeoffLimit && daysUntil <= 7 && !birthdayEvent.completed;
            ...
            {careEvents.filter((e) => e.event_type !== 'birthday').length === 0 ? (
              ...
              <div className="relative max-w-full">
                ...
                {careEvents
                  ...
                  .map((event) => (
                    <TimelineEventCard key={event.id} event={event} onDelete={handleDeleteEvent} />
                  ))}
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="grief" className="space-y-4">
            {careEvents.filter((e) => e.event_type === 'grief_loss' && !e.grief_stage_id).length ===
            0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
              ...
              careEvents
                ...
                .map((event) => (
                  <div
                    key={event.id}
                    className="space-y-4 mb-6 p-4 border border-pink-200 bg-pink-50 rounded-lg shadow-sm"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {event.grief_relationship && (
                          <p className="text-sm text-muted-foreground">
                            Relationship:{' '}
                            {event.grief_relationship.charAt(0).toUpperCase() +
                              event.grief_relationship.slice(1)}
                          </p>
                        )}
                    ...
                    <div className="mt-4">
                      ...
                      <div className="space-y-3">
                        {griefTimeline
                          .filter((s) => s.care_event_id === event.id)
                          .map((stage, index) => {
                            ...
                            return (
                              <div
                                key={stage.id}
                                className={`flex items-center gap-3 p-2 bg-pink-50 rounded ${isIgnored ? 'opacity-60' : ''}`}
                              >
                                <div
                                ...
                                <div className="flex gap-1">
                                  {isCompleted && (
                                    <Button
                                      size="sm"
                                      variant="outline"
                                      className="min-h-[44px] bg-green-50 text-green-700 border-green-200"
                                      disabled
                                    >
                                      Completed
                                    </Button>
                                  ...
                                  {isIgnored && (
                                    <Button
                                      size="sm"
                                      variant="outline"
                                      className="min-h-[44px] bg-gray-100 text-gray-500 border-gray-300"
                                      disabled
                                    >
                                      Ignored
                                    </Button>
                      ...
                      <div className="mt-4">
                        ...
                        {careEvents
                          .filter(
                            (e) => e.care_event_id === event.id && e.followup_type === 'additional'
                          )
                          .map((visit) => (
                            <div
                              key={visit.id}
                              className="flex items-start gap-3 p-2 bg-gray-50 rounded border border-gray-200 mb-2"
                            >
                              <div className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-300">
                                <span className="text-white text-xs">✓</span>
                              </div>
                              <div className="flex-1">
                                <p className="text-sm font-medium text-gray-800">{visit.title}</p>
                          ...
                          <div className="space-y-3 p-3 bg-white rounded border border-pink-300">
                            ...
                            <div>
                              ...
                              <Select
                                ...
                                onValueChange={(v) =>
                                  setAdditionalVisit({ ...additionalVisit, visit_type: v })
                                }
                              >
                            ...
                            <div>
                              ...
                              <Textarea
                                ...
                                onChange={(e) =>
                                  setAdditionalVisit({ ...additionalVisit, notes: e.target.value })
                                }
                                rows={2}
                                className="text-sm"
                              />
                            ...
                            <div className="flex gap-2">
                              ...
                              <Button
                                size="sm"
                                onClick={() => logAdditionalVisit(event)}
          ...
          <TabsContent value="accident">
            {careEvents.filter(
              (e) => e.event_type === 'accident_illness' && !e.accident_stage_id && !e.care_event_id
            ).length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
                No accident/illness visits recorded.
              </p>
            ) : (
              careEvents
                .filter(
                ...
                .map((event) => (
                  <div
                    key={event.id}
                    className="space-y-4 mb-6 p-4 border border-blue-200 bg-blue-50 rounded-lg shadow-sm relative"
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <h4 className="font-semibold text-lg mb-1">
                          🏥 {event.description || event.title || 'Accident/Illness Visit'}
                        </h4>
                        <p className="text-sm text-muted-foreground">
                          Date: {formatDate(event.event_date, 'dd MMM yyyy')}
                        </p>
                        {event.hospital_name &&
                          event.hospital_name !== 'N/A' &&
                          event.hospital_name !== 'null' &&
                          event.hospital_name !== 'NULL' && (
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="space-y-3">
                        {accidentTimeline
                          .filter((t) => t.care_event_id === event.id)
                          .map((stage, index) => {
                            const isIgnored = stage.ignored === true;
                            const isCompleted = stage.completed === true;
                            return (
                              <div
                                key={stage.id}
                                className={`flex items-center gap-3 p-2 bg-blue-50 rounded ${isIgnored ? 'opacity-60' : ''}`}
                              >
                                <div
                                  className={`w-8 h-8 rounded-full flex items-center justify-center ${
                                ...
                                <div className="flex-1">
                                  <p className="text-sm font-medium">
                                    {stage.stage === 'first_followup'
                                      ? 'First Follow-up'
                                      : stage.stage === 'second_followup'
                                        ? 'Second Follow-up'
                                        : 'Final Follow-up'}
                                  </p>
                                  <p className="text-xs text-muted-foreground">
                                      ...
                                      <DropdownMenuContent align="end">
                                        <DropdownMenuItem
                                          onClick={async () => {
                                            try {
                                              await api.post(
                                                `/accident-followup/${stage.id}/ignore`
                                              );
                          ...
                          {event.visitation_log.map((log, idx) => (
                            <div key={idx} className="text-sm bg-muted/30 p-3 rounded">
                              <p className="font-medium">
                                {log.visitor_name} - {formatDate(log.visit_date, 'dd MMM yyyy')}
                              </p>
                              <p className="text-muted-foreground">{log.notes}</p>
                              {log.prayer_offered && (
                                <p className="text-xs text-primary-600 mt-1">✓ Prayer offered</p>
                              )}
                            </div>
                          ))}
                        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  {careEvents.filter((e) => e.event_type === 'financial_aid').length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {careEvents
                        .filter((e) => e.event_type === 'financial_aid')
                        .map((event) => (
                          <div
                            key={event.id}
                            className={`p-4 rounded-lg border relative hover:shadow-lg transition-all ${event.ignored ? 'bg-gray-50 border-gray-300 card-border-left-gray opacity-70' : 'bg-purple-50 border-purple-200 card-border-left-purple'}`}
                          >
                            ...
                            <div className="flex items-start justify-between gap-3">
                              <div className="flex items-start gap-3 flex-1 min-w-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {/* Aid Type */}
                                  <p className="text-xs text-muted-foreground mt-1">
                                    {event.aid_type?.charAt(0).toUpperCase() +
                                      event.aid_type?.slice(1)}
                                  </p>
                                  {/* Date */}
                        ...
                        {aidSchedules
                          ...
                          .map((schedule) => {
                            ...
                            return (
                              <div
                                key={schedule.id}
                                className={`p-4 rounded-lg border relative hover:shadow-lg transition-all ${isIgnored ? 'bg-gray-50 border-gray-300 card-border-left-gray opacity-70' : 'bg-purple-50 border-purple-200 card-border-left-purple'}`}
                              >
                                ...
                                <div className="flex items-start justify-between gap-3">
                                  <div className="flex items-start gap-3 flex-1 min-w-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <p className="text-xs text-muted-foreground mt-1">
                                        📅 Next:{' '}
                                        {formatDate(schedule.next_occurrence, 'dd MMM yyyy')}
                                      </p>
                                    </div>
                                  </div>
                                          ...
                                          showConfirm(
                                            ...
                                            async () => {
                                              try {
                                                ...
                                                toast.success(
                                                  'Payment distributed! Schedule advanced to next occurrence.'
                                                );
                                                queryClient.invalidateQueries({
                                                  queryKey: ['member', id],
                                                });
                                      ...
                                      <DropdownMenuItem
                                        onClick={async () => {
                                          try {
                                            ...
                                            toast.success(
                                              `Payment ignored! Next payment: ${response.data.next_occurrence}`
                                            );
                                            queryClient.invalidateQueries({
                                              queryKey: ['member', id],
                                            });
                  ...
                  {aidSchedules.some(
                    (s) => s.ignored_occurrences && s.ignored_occurrences.length > 0
                  ) && (
                    <div className="border-t pt-4">
                      <h4 className="font-semibold text-foreground mb-3">
                        Ignored/Missed Payments
                      </h4>
                      <div className="space-y-2">
                        {aidSchedules
                          .filter((s) => s.ignored_occurrences && s.ignored_occurrences.length > 0)
                          .map((schedule) => (
                            <div
                              key={`ignored-${schedule.id}`}
                              className="p-3 bg-gray-100 rounded border border-gray-300 opacity-70"
                            >
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                          ...
                                          onClick={async () => {
                                            showConfirm(
                                              ...
                                              async () => {
                                                try {
                                                  await api.delete(
                                                    `/financial-aid-schedules/${schedule.id}/ignored-occurrence/${date}`
                                                  );
                                        ...
                                        showConfirm(
                                          ...
                                          async () => {
                                            try {
                                              ...
                                              await api.post(
                                                `/financial-aid-schedules/${schedule.id}/clear-ignored`
                                              );
                  ...
                  <div className="pt-4 border-t">
                    <p className="text-right font-semibold text-foreground">
                      ...
                      {careEvents
                        .filter(
                          (e) =>
                            e.event_type === 'financial_aid' && !e.ignored && e.completed !== false
                        )
            ...
            <div>
              ...
              <Popover open={followUpDateOpen} onOpenChange={setFollowUpDateOpen}>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start text-left font-normal">
                    ...
                    {noteForm.follow_up_date
                      ? formatDate(noteForm.follow_up_date, 'dd MMM yyyy')
                      : 'Select date'}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <CalendarComponent
                    mode="single"
                    selected={
                      noteForm.follow_up_date ? new Date(noteForm.follow_up_date) : undefined
                    }
                    onSelect={(date) => {
                      if (date) {
                        setNoteForm({
              ...
              {noteForm.follow_up_date && (
                <Button
                  ...
                  onClick={() =>
                    setNoteForm({ ...noteForm, follow_up_date: '', follow_up_notes: '' })
                  }
                >
                  Clear date
                </Button>
