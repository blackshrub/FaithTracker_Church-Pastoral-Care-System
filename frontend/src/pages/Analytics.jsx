...
export const Analytics = () => {
  ...
  const { member_stats, demographics, events_by_type, events_by_month, financial, grief, trends } =
    data;
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {member_stats?.with_photos || 0} {t('with_photos')}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  Rp {financial?.total_aid?.toLocaleString('id-ID') || 0}
                </p>
                <p className="text-xs text-muted-foreground">
                  {financial?.schedules || 0} {t('active_schedules')}
                </p>
              </div>
      ...
      <Tabs defaultValue="demographics" className="w-full" onValueChange={(v) => setActiveTab(v)}>
        ...
        <TabsContent value="demographics" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('membership_status')}</CardTitle>
              </CardHeader>
              <CardContent>
                <PieChart
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('member_categories')}</CardTitle>
              </CardHeader>
              <CardContent>
                <BarChart
        ...
        <TabsContent value="trends" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('population_analysis_by_age')}</CardTitle>
              </CardHeader>
              <CardContent>
                <BarChart
                  data={trends?.age_groups || []}
                  color={COLORS.demographic[0]}
                  height={300}
                />
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('engagement_by_membership')}</CardTitle>
              </CardHeader>
              <CardContent>
                <BarChart
                  data={trends?.membership_trends || []}
                  color={COLORS.primary[2]}
                  height={300}
                />
              </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t('ai_insights_recommendations')}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded">
                    <p className="font-semibold text-blue-900 dark:text-blue-100">
                      📊 {t('analytics_page.population_insights') || 'Population Insights'}
                    </p>
                    <div className="mt-2 space-y-1">
                      {trends?.insights?.length > 0 ? (
                        ...
                        <p className="text-sm text-blue-700 dark:text-blue-300">
                          •{' '}
                          {t('analytics_page.no_insights_available') ||
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded">
                    <p className="font-semibold text-green-900 dark:text-green-100">
                      💡 {t('analytics_page.care_adaptations') || 'Care Adaptations'}
                    </p>
                    <div className="mt-2 space-y-1">
                      {trends?.care_adaptations?.length > 0 ? (
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300">
                          •{' '}
                          {t('analytics_page.no_adaptations_needed') ||
                            'Continue current care programs'}
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded">
                  <p className="font-semibold text-purple-900 dark:text-purple-100">
                    🎯{' '}
                    {t('analytics_page.strategic_recommendations') || 'Strategic Recommendations'}
                  </p>
                  <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <p className="text-sm font-medium text-purple-700 dark:text-purple-300">
                        {t('analytics_page.high_priority')}
                      </p>
                      <p className="text-sm text-purple-600 dark:text-purple-400">
                        {trends?.strategic_recommendations?.high ||
                          t('analytics_page.no_high_priority_actions')}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-purple-700 dark:text-purple-300">
                        {t('analytics_page.medium_priority')}
                      </p>
                      <p className="text-sm text-purple-600 dark:text-purple-400">
                        {trends?.strategic_recommendations?.medium ||
                          t('analytics_page.engagement_levels_healthy')}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-purple-700 dark:text-purple-300">
                        {t('analytics_page.long_term') || 'Long Term'}
                      </p>
                      <p className="text-sm text-purple-600 dark:text-purple-400">
                        {trends?.strategic_recommendations?.long ||
                          t('analytics_page.develop_ministry_approaches')}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <TabsContent value="engagement" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('member_engagement_status')}</CardTitle>
              </CardHeader>
              <CardContent>
                <PieChart
                  data={demographics?.engagement || []}
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  {t('care_events_by_month')} ({new Date().getFullYear()})
                </CardTitle>
              </CardHeader>
              <CardContent>
                <AreaChart
        ...
        <TabsContent value="financial" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('financial_aid_by_type')}</CardTitle>
              </CardHeader>
              <CardContent>
                <BarChart
                  data={financial?.by_type || []}
                  color={COLORS.financial[0]}
                  height={300}
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('aid_distribution_summary')}</CardTitle>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-4 bg-blue-50 rounded">
                    <p className="text-2xl font-bold text-blue-700">
                      Rp {financial?.scheduled_amount?.toLocaleString('id-ID') || 0}
                    </p>
        ...
        <TabsContent value="care" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>{t('care_events_distribution')}</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="predictive" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('member_care_insights')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="p-3 bg-red-50 rounded">
                    <p className="font-semibold text-red-700">
                      {t('analytics_page.high_priority')} (
                      {demographics?.engagement?.find((e) => e.name === 'inactive')?.value || 0}{' '}
                      {t('misc.members')})
                    </p>
                    <p className="text-sm text-muted-foreground">
                      {t('analytics_page.members_disconnected_attention')}
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-amber-50 rounded">
                    <p className="font-semibold text-amber-700">
                      {t('analytics_page.medium_priority')} (
                      {demographics?.engagement?.find((e) => e.name === 'at_risk')?.value || 0}{' '}
                      {t('misc.members')})
                    </p>
                    <p className="text-sm text-muted-foreground">
                      {t('analytics_page.at_risk_followup_needed')}
                    </p>
                  </div>

                  <div className="p-3 bg-green-50 rounded">
                    <p className="font-semibold text-green-700">
                      {t('analytics_page.active_members_count', {
                        count:
                          demographics?.engagement?.find((e) => e.name === 'active')?.value || 0,
                      })}
                    </p>
                    <p className="text-sm text-muted-foreground">
                      {t('analytics_page.active_members_maintained')}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('financial_aid_effectiveness')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  {financial?.by_type?.slice(0, 4).map((type) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs text-muted-foreground">
                          avg: Rp {type.avg?.toLocaleString('id-ID')}
                        </p>
                      </div>
                    </div>
                  ))}
