...
import type { DashboardBirthday, DashboardTask, GriefStage, AccidentFollowup, FinancialAidSchedule, Member } from '@/types';

interface DashboardStatsProps {
  totalMembers?: number;
  birthdaysToday?: (DashboardBirthday & { completed?: boolean })[];
  todayTasks?: (DashboardTask & { completed?: boolean })[];
  griefDue?: GriefStage[];
  accidentFollowUp?: AccidentFollowup[];
  financialAidDue?: FinancialAidSchedule[];
  atRiskMembers?: Member[];
  disconnectedMembers?: Member[];
}
