 ...
 *
 * Props:
 *  - section (string):        Label for console logging, e.g. "Activity Feed"
 *  - fallbackTitle (string):  Heading shown to the user
 *  - fallbackMessage (string): Secondary explanation text
