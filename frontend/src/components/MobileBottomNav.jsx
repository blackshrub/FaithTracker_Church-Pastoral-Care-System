...
export const MobileBottomNav = () => {
  ...
  const moreMenuItems = [
    ...
    ...(user?.role === 'full_admin'
      ? [{ name: t('admin_dashboard'), href: '/admin', icon: Shield, category: 'admin' }]
      : []),
          ...
          {navigation.map((item) => {
            ...
            return (
              <LinkComponent
                ...
                className={`flex flex-col items-center justify-center gap-1 min-h-[44px] px-1 transition-all duration-200 active:scale-95 ${
                  active
